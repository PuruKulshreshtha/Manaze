...
const user = {
  0: { username: "puru", password: 1234 },
  1: { username: "rajat", password: 1234 },
};
class Login extends Component {
  ...
  render() {
    return (
      <ImageBackground
        source={require('../Image/main3.jpg')}
        ...
        <View style={styles.container}>
          <View style={styles.inputContainer}>
            <Image
              ...
              source={require("../Image/young.png")}
            />
            <TextInput
              style={styles.inputs}
          ...
          <View style={styles.inputContainer}>
            <Image
              style={styles.inputIcon}
              source={require("../Image/smart-key.png")}
            />
            <TextInput
              style={styles.inputs}
